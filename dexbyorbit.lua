...
--[[
	Console Module
		...
		local function main()
			...
			ConsoleFrame["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["5"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["6"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["8"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["backgroundOutput"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["a"]["TopImage"] = '';
			G2L["a"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["10"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["11"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["14"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["15"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["17"]["BackgroundColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["17"]["BorderColor3"] = Color3.fromRGB(127, 35, 255);
			...
			G2L["1a"]["BackgroundColor3"] = Color3.fromRGB(174, 34, 255);
			G2L["1a"]["FontFace"] = Font.new([[rbxasset://fonts/families/SourceSansPro.json]], Enum.FontWeight.Regular, Enum.FontStyle.Normal);
			G2L["1a"]["TextColor3"] = Color3.fromRGB(255, 87, 252);
			...
			G2L["1e"]["BackgroundColor3"] = Color3.fromRGB(201, 76, 255);
			...
			Console.Init = function()
				...
				elseif CtrlScroll == false then
					Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(201, 76, 255)
				end
				...
				elseif AutoScroll == false then
					Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(201, 76, 255)
				end
...
return search]==]
			...
			Explorer.Init = function()
				...
				local explorerItems = create({
					...
					{2,"Frame",{BackgroundColor3=Color3.new(0.333333, 0, 0.498039),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
					{3,"Frame",{BackgroundColor3=Color3.new(0.333333, 0, 0.498039),BorderColor3=Color3.new(0.333333, 0, 0.498039),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
					{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.new(0.592157, 0, 0.886275),PlaceholderText="Search workspace",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
			...
			Lib.ScrollBar = (function()
				...
				funcs.Texture = function(self,data)
					...
					for i,v in pairs(self.GuiElems.Button1.Arrow:GetChildren()) do
						v.BackgroundColor3 = data.ArrowColor or Color3.new(1, 0.333333, 1)
					end
					for i,v in pairs(self.GuiElems.Button2.Arrow:GetChildren()) do
						v.BackgroundColor3 = data.ArrowColor or Color3.new(1, 0.666667, 1)
					end
				end
			...
			Lib.Window = (function()
				...
				local createGui = function(self)
					local gui = create({
						...
						{2,"Frame",{Active=true,BackgroundColor3=Color3.new(0.666667, 0.333333, 1),BackgroundTransparency=1,BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.40000000596046,0,0.40000000596046,0),Size=UDim2.new(0,300,0,300),}},
						...
						{14,"Frame",{BackgroundColor3=Color3.new(1, 0.333333, 1),BackgroundTransparency=1,Name="ResizeControls",Parent={2},Position=UDim2.new(0,-5,0,-5),Size=UDim2.new(1,10,1,10),}},
...
Main = (function()
	...
	Main.IncompatibleTest = function()
		--[[local function incompatibleMessage(reason, tolerated)
			...
			t.TextWrapped = true
			t.TextScaled = true
			t.Text = "\n\n\n\n\n\n\n\nHello Skidsploit user,\nZinnia, Orbit and the Secret Service does not approve of Dex being used on your skidsploit.\nPlease consider getting something better.\n\nIncompatible Reason: "..reason.."\n\n\n\n\n\n\n\n"
	...
	Main.CreateIntro = function(initStatus) -- TODO: Must theme and show errors
		local gui = create({
			...
			{2,"Frame",{Active=true,BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Name="Main",Parent={1},Position=UDim2.new(0.5,-175,0.5,-100),Size=UDim2.new(0,350,0,200),}},
			{3,"Frame",{BackgroundColor3=Color3.new(0.729412, 0.368627, 0.937255),BorderSizePixel=0,ClipsDescendants=true,Name="Holder",Parent={2},Size=UDim2.new(1,0,1,0),}},
			...
			{8,"Frame",{BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Name="ProgressBar",Parent={3},Position=UDim2.new(0,110,0,145),Size=UDim2.new(0,0,0,4),}},
			{9,"Frame",{BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Name="Bar",Parent={8},Size=UDim2.new(0,0,1,0),}},
			...
			{11,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Creator",Parent={2},Position=UDim2.new(1,-110,1,-20),Size=UDim2.new(0,105,0,20),Text="Developed by Orbit.",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=1,}},
	...
	Main.CreateMainGui = function()
		local gui = create({
			...
			{2,"TextButton",{AnchorPoint=Vector2.new(0.5,0),AutoButtonColor=false,BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Font=4,Name="OpenButton",Parent={1},Position=UDim2.new(0.5,0,0,2),Size=UDim2.new(0,55,0,32),Text="Dex+++",TextColor3=Color3.new(1,1,1),TextSize=16,TextTransparency=0.20000000298023,}},
			{3,"UICorner",{CornerRadius=UDim.new(0,4),Parent={2},}},
			{4,"Frame",{AnchorPoint=Vector2.new(0.5,0),BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),ClipsDescendants=true,Name="MainFrame",Parent={2},Position=UDim2.new(0.5,0,1,-4),Size=UDim2.new(0,224,0,200),}},
			{5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={4},}},
			{6,"Frame",{BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),Name="BottomFrame",Parent={4},Position=UDim2.new(0,0,1,-24),Size=UDim2.new(1,0,0,24),}},
			{7,"UICorner",{CornerRadius=UDim.new(0,4),Parent={6},}},
			{8,"Frame",{BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Name="CoverFrame",Parent={6},Size=UDim2.new(1,0,0,4),}},
			{9,"Frame",{BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Name="Line",Parent={8},Position=UDim2.new(0,0,0,-1),Size=UDim2.new(1,0,0,1),}},
			...
			{18,"TextButton",{AutoButtonColor=false,BackgroundColor3=Color3.new(0.619608, 0.313725, 0.796078),BorderSizePixel=0,Font=3,Name="Main",Parent={17},Size=UDim2.new(1,0,0,60),Text="",TextColor3=Color3.new(0,0,0),TextSize=14,}},
